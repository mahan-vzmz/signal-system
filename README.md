...
| :---: | :---: |
| **Subject 01** | ![ICA](./Steps/Report_Images_Step3_Auto/Subject_01_ICA_Topomaps.png) |
...
| :---: | :---: |
| **Subject 01**<br>![Sig](./Steps/Report_Images_Step3_Auto/Subject_01_Signal_Comparison.png) | **Subject 02**<br>![Sig](./Steps/Report_Images_Step3_Auto/Subject_02_Signal_Comparison.png) |
| **Subject 03**<br>![Sig](./Steps/Report_Images_Step3_Auto/Subject_03_Signal_Comparison.png) | **Subject 04**<br>![Sig](./Steps/Report_Images_Step3_Auto/Subject_04_Signal_Comparison.png) |
| **Subject 05**<br>![Sig](./Steps/Report_Images_Step3_Auto/Subject_05_Signal_Comparison.png) | **Subject 06**<br>![Sig](./Steps/Report_Images_Step3_Auto/Subject_06_Signal_Comparison.png) |
| **Subject 07**<br>![Sig](./Steps/Report_Images_Step3_Auto/Subject_07_Signal_Comparison.png) | **Subject 08**<br>![Sig](./Steps/Report_Images_Step3_Auto/Subject_08_Signal_Comparison.png) |
| **Subject 09**<br>![Sig](./Steps/Report_Images_Step3_Auto/Subject_09_Signal_Comparison.png) | **Subject 10**<br>![Sig](./Steps/Report_Images_Step3_Auto/Subject_10_Signal_Comparison.png) |
...
| :---: | :---: | :--- |
| **Subject 01** | ![Diag](./Steps/Report_Images_Step8_Diagnosis/Subject_01_Diagnosis_Map.png) | 🔴 **Drowsy / Relaxed** (Ratio: 2.42)<br>🟠 **Attention Deficit** (Ratio: 2.43) |
| **Subject 02** | ![Diag](./Steps/Report_Images_Step8_Diagnosis/Subject_02_Diagnosis_Map.png) | 🔴 **Drowsy / Relaxed** (Ratio: 6.09)<br>🟠 **Attention Deficit** (Ratio: 3.95) |
| **Subject 03** | ![Diag](./Steps/Report_Images_Step8_Diagnosis/Subject_03_Diagnosis_Map.png) | 🔴 **Drowsy / Relaxed** (Ratio: 1.59)<br>🟠 **Attention Deficit** (Ratio: 2.34) |
| **Subject 04** | ![Diag](./Steps/Report_Images_Step8_Diagnosis/Subject_04_Diagnosis_Map.png) | 🔴 **Drowsy / Relaxed** (Ratio: 5.86)<br>🟢 **GOOD FOCUS** (Ratio: 1.90) |
| **Subject 05** | ![Diag](./Steps/Report_Images_Step8_Diagnosis/Subject_05_Diagnosis_Map.png) | 🔴 **Drowsy / Relaxed** (Ratio: 2.03)<br>🟠 **Attention Deficit** (Ratio: 4.08) |
| **Subject 06** | ![Diag](./Steps/Report_Images_Step8_Diagnosis/Subject_06_Diagnosis_Map.png) | 🔴 **Drowsy / Relaxed** (Ratio: 10.64)<br>🟠 **Attention Deficit** (Ratio: 2.38) |
| **Subject 07** | ![Diag](./Steps/Report_Images_Step8_Diagnosis/Subject_07_Diagnosis_Map.png) | 🔴 **Drowsy / Relaxed** (Ratio: 3.84)<br>🟠 **Attention Deficit** (Ratio: 3.83) |
| **Subject 08** | ![Diag](./Steps/Report_Images_Step8_Diagnosis/Subject_08_Diagnosis_Map.png) | 🔴 **Drowsy / Relaxed** (Ratio: 11.16)<br>🟠 **Attention Deficit** (Ratio: 14.53) |
| **Subject 09** | ![Diag](./Steps/Report_Images_Step8_Diagnosis/Subject_09_Diagnosis_Map.png) | 🔴 **Drowsy / Relaxed** (Ratio: 17.02)<br>🟠 **Attention Deficit** (Ratio: 3.86) |
| **Subject 10** | ![Diag](./Steps/Report_Images_Step8_Diagnosis/Subject_10_Diagnosis_Map.png) | 🔴 **Drowsy / Relaxed** (Ratio: 8.14)<br>🟠 **Attention Deficit** (Ratio: 4.34) |
...
2.  **تایید فیزیولوژیک (Physiological Validation):** نقشه‌های توپوگرافی در گام ششم نشان دادند که تمرکز انرژی باند **آلفا (۸-۱۲ هرتز)** در ناحیه **پس‌سری (Occipital)** قرار دارد.این یافته با فیزیولوژی طبیعی مغز در حالت استراحت (چشمان بسته) کاملاً مطابقت دارد و صحت پردازش‌ها را تایید می‌کند. 
